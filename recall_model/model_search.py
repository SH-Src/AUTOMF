...
class Network(nn.Module):
    def __init__(self, vocab_size1, vocab_size2, vocab_size3, d_model, steps, steps2, criterion, lamb, num_classes=1025):
    ...
    def forward(self, x1, x2, s, text):
        ...
        return torch.softmax(self.classifier(out).squeeze(), dim=-1)
